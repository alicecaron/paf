...
import cloud.GenerateCloudData;
...
public class Comptage {
	...
	public static void main(String[] args) throws IOException {
		String repository = "docTxt/texts";
		...
		/*******************************************************************************************************
		 *Génère un fichier .txt de l'ensemble des lemmes importants du corpus, avec leur fréquence d'apparition
		 *******************************************************************************************************/
		new GenerateCloudData(corpusLemms);
...
//		
	...
	private static void sortUselessWords() {
		for (Words word : corpusWords.values())
			if ( word.getType().matches(regex) || (word.getType().equals("MOTINC")&&corpusWords.containsKey(word.getWord().toLowerCase())))
				word.setFiltered(true);	
	}
	private static void sortUselessLemms() {
		for (Lemm lemm : corpusLemms.values())
			if (lemm.getType().matches(regex) || (lemm.getType().equals("MOTINC")&&corpusWords.containsKey(lemm.getLemm().toLowerCase())))
	...
	private static void displayDocumentSimilarities() throws IOException {
		ExportSimilarities exportSimilarities=new ExportSimilarities("csv/similarites.csv");
